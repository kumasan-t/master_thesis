\begin{document}
	...
	degree in relazione con lo score della betweenness centrality
	
	Nuove cose: tagli iterativi sulla rete effettivamente la smontano per bene. La rete non si partiziona equamente ma mostra sottografi da poco e niente (size 1 e 2)
	...
	train model può essere utile per modellizzare un batch di nodi che entrano nella rete ogni 10 minuti?
